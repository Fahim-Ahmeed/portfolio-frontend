      ...
      <div>
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          <div className="flex justify-center items-center">
            <img
              src="https://i.postimg.cc/28tfBfxr/me.png"
              alt="avatar"
          ...
          <div className="flex justify-center flex-col tracking-[1px] text-xl gap-5">
            <p>
              My name is Fahim Ahmed, but my friends call me fahim. I have been completed my graduation in computer science engineering from daffodil international univarsity. I work as
